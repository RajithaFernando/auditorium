...
<script>
    ...
    var options = {
        ...
        data: [{
            ...
            type: "bar",
            dataPoints: [
                            { y: <?php echo $ticket1; ?>, label: --, indexLabel: "VIP" },
                            { y: <?php echo $ticket2; ?>, label: --, indexLabel: "First Class" },
                            { y: <?php echo $ticket3; ?>, label: --, indexLabel: "Second Class" }
            ...
            <div class="container-fluid">
               ...
               <div class="col-md-7 col-4 align-self-center">
                ...
                <?php
                    ...
                    // $query1 = "SELECT * FROM tempEvents WHERE manager_id = $mid  AND status	='confirmed' order by date";
